...
<html lang="en">
  ...
  <div class="container">
    <div class="row">
        <div class="col">
            <h2 class="text-center text-primary">DAFTAR MAHASISWA</h2>
            <form action="POST">
    ...
    <div class="row">
        <div class="col">
            <table class="table table-bordered table-  table-hover table-sm text-center">
                <thead>
                    <tr>
                        <th>NO</th>
                        <th>ID</th>
  ...
  <!-- Modal -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <label class="text text-dark">NAMA </label>
            <input type="text" name="nama" class="form-control">
            <label>Jenis Kelamin </label>
                <select class="form-select" aria-label="Default select example" name="jekel">
